    ...
    <>
      <div className="summary">
        ...
        <div className="summary__calculations">
          ...
          <div className="sumamry__vat">
            <p className="summary__vat-title">{`vat (included)`}</p>
            <p className="summary__shipping-price">$1079</p>
          </div>
          <div className="sumamry__grand-total">
            <p className="summary__grand-total-title">grand total</p>
            <p className="summary__grand-total-price">$1079</p>
          </div>
        </div>
